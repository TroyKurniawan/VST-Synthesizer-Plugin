...
public:
    ...
    // This function will grab the slider value from the PluginProcessor.cpp and send it to here for the actual attack to change.
    void getParam(float* attack)
    {
        env1.setAttack(double(*attack));    // Argument is in milliseconds
