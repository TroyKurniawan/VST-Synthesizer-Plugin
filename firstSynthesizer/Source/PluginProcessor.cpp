...
#endif
{
    ...
    // Here, the 5 represents how many maximum voices the synth is capable of simulatenously.
    // In other words, the synth is capable of playing 5 notes (voices) at the same time.
...
void SynthFrameworkAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    // Clear out unused samples from the last key pressed
